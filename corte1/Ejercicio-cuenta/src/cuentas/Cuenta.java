...
// 5. DIP: Dependemos de abstracciones (Notificador), no de implementaciones (Email)
...
// 2. OCP: El procesador está cerrado a cambios pero abierto a nuevos notificadores
